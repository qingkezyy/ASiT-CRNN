...
class SEDTask4(pl.LightningModule):
    ...
    def test_step(self, batch, batch_indx):
        ...
        if not self.evaluation:
            ...
            # predictions_multi = np.argmax(y, axis=1)  
            # print("Predicted Multi-label Binary Labels:\n", predictions_multi) 
            # print('predictions_multi:', predictions_multi.shape)
            # np.save("./label_npu_SSAST.npy", predictions_multi)
